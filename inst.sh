...
show_progress "Now, last step. We are gonna install Virtualmin - Webmin package"
wget http://software.virtualmin.com/gpl/scripts/install.sh -O webmin.sh
